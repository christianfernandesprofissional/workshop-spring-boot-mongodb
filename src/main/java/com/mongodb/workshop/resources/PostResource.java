...
public class PostResource {
	...
	@RequestMapping(value = "/filteredsearch", method = RequestMethod.GET)
	public ResponseEntity<List<Post>> filteredSearch(
		...
		List<Post> list = service.filteredSearch(text, min, max);
		return ResponseEntity.ok().body(list);
	}
